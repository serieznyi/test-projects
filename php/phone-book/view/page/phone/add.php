 ...
 * @var string $tmpImageDir
 */

use App\Form\BookForm;
use App\Web\Util\ValidationUtil;

$context->vars['title'] = 'Add new phone';
...
<form action="/phone/add" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="preview">
            <? if($form->photo):?>
                <img src="<?=$tmpImageDir . $form->photo?>" width="150" height="150" />
            <?php endif;?>
        </div>
    ...
    <button type="submit" class="btn btn-success">Add new phone</button>
</form>